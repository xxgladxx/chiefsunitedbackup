...
credits_url = "https://images-ext-1.discordapp.net/external/kYJx8YK6XrdnbhUQEHHbFtsmN4X2ga4LbzgVMFllKi8/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/698376874186768384/a_d545d6bab43dd8e041268f1d51fa4199.gif?width=473&height=473"
guild_defaults = {
    "mincreds" : 0,
    "active" : 0,
    "player1" : 0,
...
class Duel(commands.Cog):
    ...
    @duel.command(name="rules")
    async def duel_rules(self, ctx):
        msg = "{4} \n \n {0}**Rules and Regulations**{0} \n \n {1} The format is simple, you have to play a best of 3 friendly battle in duel format. \n \n {1} In duel format, cards used in a deck cannot be repeated for the next games in a duel bo3. \n \n {1} Currently, you have to check if the opponent has repeated cards yourself, feature to auto-check the card repetition will be added soon. \n \n {1} If you won the duel and your opponent claimed the duel reward, please ping an Admin. \n \n {1} Repeating cards, BMming ( spamming emotes in duel games ), offensive behaviour, claiming rewards even if not winning the duel will lead to a **DQ** from the duel. All your credits will be reduced to 0 and you'll get a temporary ban from the bot games{3}. \n\n {5} **How to play duels?** \n Check the pinned message in <#828700198616039484>."
        sword = '<:sword:827893697068662814>'
        arrow = '<:bc:827893695474696223>'
        icespirit = '<:strophy:828219808138395648>'
        banhammer = ':hammer:'
        lvl = '<:lvl:827893695047139348>'
        await ctx.send(msg.format(sword, arrow, icespirit,banhammer,ctx.author.mention,lvl))	
