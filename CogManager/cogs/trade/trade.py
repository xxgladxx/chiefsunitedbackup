...
class Trade(commands.Cog):
    ...
    async def search(self, ctx, *, card):
        ...
        embed.set_author(name="{} Traders".format(card),
                         icon_url="https://images-ext-2.discordapp.net/external/NlEeweaq5B3VEQAX1J5SSRkBFYkkTewfeHOCxvm-KYM/%3Fsize%3D1024/https/cdn.discordapp.com/icons/760377603982360597/a_00830f54a39736534fa7a1d0b71f6057.gif?width=473&height=473")
    ...
    async def info(self, ctx, member : discord.Member = None):
        ...
        member_data = await self.database.member(member).all()
