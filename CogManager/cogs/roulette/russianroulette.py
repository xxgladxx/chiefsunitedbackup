...
class RussianRoulette(commands.Cog):
    ...
    async def russian(self, ctx, cost:int=None):
     if ctx.channel.id == 822117030772736000:
        ...
        await ctx.send("{}, I can kick you to Russia to play this game :globe_with_meridians:, but for now, please go to <#822117030772736000> if you want a shorter way!".format(ctx.author.mention))
